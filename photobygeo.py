...
def parse_instagram(location_latitude, location_longitude, distance, min_timestamp, max_timestamp, date_increment, instagram_access_token):
	...
	while (1):
		...
		instagram_json = json.loads(get_instagram(location_latitude, location_longitude, distance, local_min_timestamp, local_max_timestamp, instagram_access_token))
